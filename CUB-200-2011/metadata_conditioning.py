...
def cub_field_configs(dataset, species_emb_dim: int = 32) -> list:
    return [
        {
            "name":       "species",
            "type":       "categorical",
            "vocab_size": len(dataset.species2idx),
            "emb_dim":    species_emb_dim,
        },
        {
            "name":       "throat_color",
            "type":       "categorical",
            "vocab_size": dataset.num_throat_colors,
            "emb_dim":    32,
        },
        {
            "name":       "forehead_color",
            "type":       "categorical",
            "vocab_size": dataset.num_forehead_colors,
            "emb_dim":    32,
        },
        {
            "name":       "belly_color",
            "type":       "categorical",
            "vocab_size": dataset.num_belly_colors,
            "emb_dim":    32,
        },
        {
            "name":       "nape_color",
            "type":       "categorical",
            "vocab_size": dataset.num_nape_colors,
            "emb_dim":    32,
        },
    ]
